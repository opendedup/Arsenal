...
class ObjectMD {
     ...
     * {@link ObjectMD.createFromStored()} to load from a stored
     * metadata blob and check the returned value for errors.
     *
     * @constructor
     * @param {object} [objMd] - object metadata coming from storage
     * (internal only)
     */
    constructor(objMd = undefined) {
        ...
        if (objMd !== undefined) {
            ...
            // set new object md modified time to current time
    ...
    _convertToLatestModel() {
        ...
        if (!Array.isArray(this._data.location)) {
